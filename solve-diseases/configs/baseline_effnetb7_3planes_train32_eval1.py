...
class Configs(Base):
    ...
    TRAIN_DATA_PATHS=[
        ('/app/segment/dataset/train_3d/images/kidney_3_dense.npy','/app/segment/dataset/train_3d/masks/kidney_3_dense.npy',[0,1,2]),
        ('/app/segment/dataset/train_3d/images/kidney_3_sparse.npy','/app/segment/dataset/train_3d/masks/kidney_3_sparse.npy',[0,1,2]),
