...
class Configs(Base):
    ...
    def __init__(self,is_inference=False):
        ...
        self.model = TimmUnet_v2m(encoder="tf_efficientnetv2_l_in21k", in_chans=1, num_class=1, pretrained=not is_inference)
        ...
        train_albums = [
            ...
            A.Perspective(scale=(0.05, 0.15), keep_size=True, pad_mode=cv2.BORDER_CONSTANT,pad_val=80,mask_pad_val=0,interpolation=1, p=0.5),
